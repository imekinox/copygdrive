    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Google Drive Metadata:</strong> Folder and file names, sizes, and structure information (we do NOT access or store file contents)</li>
            <li><strong>Usage Data:</strong> Copy job history, transfer volumes, and feature usage</li>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Secure data centers via Cloudflare</li>
          </ul>

          <h2 className="text-2xl font-semibold mt-8 mb-4">5. Data Retention</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Account Data:</strong> Retained while your account is active</li>
            <li><strong>Copy Job History:</strong> Retained for 90 days for support and debugging</li>
            <li><strong>OAuth Tokens:</strong> Automatically refreshed and deleted upon account deletion</li>
            <li><strong>Logs:</strong> Server logs retained for 30 days</li>
          </ul>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">9. California Privacy Rights</h2>
          <p>
            California residents have additional rights under the CCPA, including the right to know, delete, opt-out, 
            and non-discrimination. To exercise these rights, contact us using the information below.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Contract:</strong> To provide the DriveCloner service you requested</li>
